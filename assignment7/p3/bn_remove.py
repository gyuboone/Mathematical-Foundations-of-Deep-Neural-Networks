...
model_test.conv1[0].weight.data = model.conv1[0].weight * (conv1_bn_gamma/torch.sqrt(conv1_bn_var + eps)).view(-1,1,1,1)
model_test.conv1[0].bias.data = conv1_bn_beta + conv1_bn_gamma*(model.conv1[0].bias-conv1_bn_mean)/torch.sqrt(conv1_bn_var + eps)

model_test.conv2[0].weight.data = model.conv2[0].weight * (conv2_bn_gamma/torch.sqrt(conv2_bn_var + eps)).view(-1,1,1,1)
model_test.conv2[0].bias.data = conv2_bn_beta + conv2_bn_gamma*(model.conv2[0].bias-conv2_bn_mean)/torch.sqrt(conv2_bn_var + eps)

model_test.fc1[0].weight.data = model.fc1[0].weight * (fc1_bn_gamma/torch.sqrt(fc1_bn_var + eps)).view(-1,1)
model_test.fc1[0].bias.data = fc1_bn_beta + fc1_bn_gamma*(model.fc1[0].bias-fc1_bn_mean)/torch.sqrt(fc1_bn_var + eps)
